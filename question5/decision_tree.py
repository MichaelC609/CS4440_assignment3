...
# SPECIFICATION: Create and train, test and output the performance of three 
#       models based on the three csv files, each containing a training set
...
for ds in dataSets:
    ...
    for row in data_training:
        ...
        # Marital Status: one-hot encoding [Single, Divorced, Married]
        single = 1 if row[1] == 'Single' else 0
        divorced = 1 if row[1] == 'Divorced' else 0
        married = 1 if row[1] == 'Married' else 0
        
        # Taxable Income: remove 'k' and convert to float
    ...
    for i in range (10):
       ...
       for data in data_test:
           ...
           #--> add your Python code here
           # Transform test instance features
